            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                        ...
                        echo "<td>";
                            echo "<button class='btn btn-sm btn-primary editBtn'data-id='".$row['id']."' data-code='".$row['course_code']."' data-po1='".$row['po1']."' data-po2='".$row['po2']."' data-po3='".$row['po3']."' data-po4='".$row['po4']."' data-po5='".$row['po5']."'><i class='bi bi-pencil'></i></button>";
    ...
    <div class="modal-content">
        ...
        <form method="post">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" name="save_mapping_psos">Save</button>
            </div>
        </form>
    </div>
</div>
<div id="editNewModal" class="modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Edit Mapping of COs with Psos</h2>
        ...
        <form method="post">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" name="update_mapping_psos">Update</button>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="POST" action="" id="deleteForm">
                    ...
                    <button type="save" class="btn btn-danger" name="delete_mapping_psos">Delete</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.querySelectorAll('.restricted-input').forEach(input => {
        input.addEventListener('input', function () {
            ...
            if (!/^[SML]*$/.test(value)) { 
                this.value = value.replace(/[^SML]/g, ''); 
            } else {
                this.value = value; 
            }
        });
